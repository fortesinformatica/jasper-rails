...
module JasperRails
  ...
  class JasperReportsRenderer < AbstractRenderer
    ...
    attr_accessor :block
    UTF8 = Rjb::import('java.nio.charset.StandardCharsets.UTF_8')
    ...
    def fill(jasper_file, datasource, parameters, controller_options={})
      ...
      parameters.each do |key, value|
        jasper_params.put(_String.new(key.to_s, UTF8), parameter_value_of(value))
      end
